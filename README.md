...
* friendica-find-blocks.sh: Allows recursively importing the block lists of the most popular instances into your Friendica instance. You can also configure a list of exceptions by adding them to the `overrides` parameter in your `settings.csv` file.
